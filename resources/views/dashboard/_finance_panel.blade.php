...
<div class="surface-card reveal-on-load card-tone-coral-light">
    <div class="d-flex justify-content-between align-items-start gap-3 mb-3">
        ...
        <div class="text-end">
            <div class="display-6 fw-bold text-success mb-0">Rp{{ number_format($totalRevenue, 0, ',', '.') }}</div>
    ...
    <div class="row g-3 mb-4">
        <div class="col-6 col-lg-3">
            <div class="border rounded-4 p-3 text-center h-100" style="background: rgba(31, 122, 140, 0.06);">
                <div class="fs-3 fw-bold text-info">{{ $stats['invoiceActive'] }}</div>
                <div class="small text-muted">Invoice Aktif</div>
            </div>
        </div>
        <div class="col-6 col-lg-3">
            <div class="border rounded-4 p-3 text-center h-100" style="background: rgba(226, 166, 75, 0.1);">
                <div class="fs-3 fw-bold text-warning">{{ $stats['paymentPending'] }}</div>
                <div class="small text-muted">Pending Verifikasi</div>
            </div>
        </div>
        <div class="col-6 col-lg-3">
            <div class="border rounded-4 p-3 text-center h-100" style="background: rgba(25, 135, 84, 0.06);">
                <div class="fs-3 fw-bold text-success">Rp{{ number_format($totalRevenue, 0, ',', '.') }}</div>
                <div class="small text-muted">Pendapatan</div>
            </div>
        </div>
        <div class="col-6 col-lg-3">
            <div class="border rounded-4 p-3 text-center h-100" style="background: rgba(220, 53, 69, 0.06);">
